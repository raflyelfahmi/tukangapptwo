...
class CeramistController extends GetxController {
      ...
      if (snapshot.value != null) {
        ...
        if (values is Map<dynamic, dynamic>) {
          values.forEach((key, value) {
            ...
            if (value is Map<String, dynamic> && value['role'] == 'tukang' && value['rolesKeunggulan'] != null && (value['rolesKeunggulan'] as List).contains('Ceramist atau Pasang Keramik')) {
            ...
            } else if (value is Map && value['role'] == 'tukang' && value['rolesKeunggulan'] != null && (value['rolesKeunggulan'] as List).contains('Ceramist atau Pasang Keramik')) {
              if (key != currentUserUid) {
                userList.add({
                  'uid': key,
                  'name': value['name'],
...
class CeramistView extends StatelessWidget {
  final CeramistController ceramistController = Get.put(CeramistController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (ceramistController.accessDenied.value) {
          return Center(
            child: Text(
              'Akses Ditolak',
        ...
        } else if (ceramistController.isLoading.value) {
          return const Center(child: CircularProgressIndicator());
        } else if (ceramistController.users.isEmpty) {
          return const Center(
            child: Text(
              'No users found',
            ...
            child: Column(
              ...
              children: <Widget>[
                ListView.builder(
                  ...
                  itemCount: ceramistController.users.length,
                  itemBuilder: (context, index) {
                    var user = ceramistController.users[index];
                    return InkWell(
                      onTap: () {
