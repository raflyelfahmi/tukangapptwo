...
import 'package:tukangapptwo/app/modules/HistoryUser/views/history_user_view.dart';
...
class ProfilscreenView extends StatefulWidget {
  ...
  @override
  _ProfilscreenViewState createState() => _ProfilscreenViewState();
}

class _ProfilscreenViewState extends State<ProfilscreenView> {
  int _currentIndex = 1;
  ...
  void _onItemTapped(int index) {
    setState(() {
      ...
      if (index == 1) {
        // No need to navigate to ProfilscreenView again from itself
      }
      if (index == 0) {
        Navigator.push(
          context,
      ...
      if (index == 2) {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => HistoryUserView()),
        );
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Profil Pemesan'),
        centerTitle: true,
      ),
      body: Stack(
        children: [
